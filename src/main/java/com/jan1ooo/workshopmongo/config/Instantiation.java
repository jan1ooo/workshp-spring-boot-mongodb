...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post pos1 = new Post(null, sdf.parse("21/02/2023"), "Pariu SP", "To indo pra SP agora", maria);
        Post pos2 = new Post(null, sdf.parse("22/02/2023"), "Bom dia", "Bom dia, tenham um otimo dia", maria);
